...
```
* de4c5be (HEAD -> main) 新增 --fill-bin 命令：下载 zip 列出 exe 由用户指定主程序，自动补 bin/shortcuts 与 extract_dir(模板)；修复 autoupdate 生成时丢弃既有模板键
* dc3283a (origin/main, origin/HEAD) progress.md 更新提交历史
