...
```
* 704cf77 (HEAD -> main) 自动更新时更正 bin/shortcuts/pre_install 中的版本号：新增 sync_bin_version（旧版本号子串→新版本，固定名零影响），--all 每晚更新不再产生版本化文件名失配
* 1be27a2 (origin/main, origin/HEAD) progress.md 更新提交历史
* 175daba 自动更新第三方软件
