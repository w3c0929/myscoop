...
```
* e309aa6 (HEAD -> main) SwitchHosts 5.0.1 便携版换代：替换发布同名 zip（2026-09-19 维护版），hash 更新为 sha256:982e72d5…（README 版本列已为 5.0.1，无需文字变更）
* e63788a (origin/main, origin/HEAD) progress.md 更新提交历史
